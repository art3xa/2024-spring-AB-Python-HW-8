...
class Cart(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "products"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "products": [ProductQuantity.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
        return _obj
